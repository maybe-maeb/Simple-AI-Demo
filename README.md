...
### You are welcome to use and modify this project however you would like. I've duplicated the [state controller](Assets/Scripts/StateController) into other projects where I need a state machine to prevent having to start from scratch each time.
